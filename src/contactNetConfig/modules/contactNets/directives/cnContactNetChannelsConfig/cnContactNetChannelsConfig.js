(function() {
  ...
  module.exports = function($cnContactNets) {
    ...
    function controller ($scope) {
        ...
        $cnContactNets.getShortNumbering().then(function () {
            if($scope.contactnet.contactNetInfo == null)
                return;
            $scope.contactnet.contactNetInfo.voiceChannelParams.outgoingConfiguration.outgoingConfig.comunities = arguments[0];
            console.log('getShortNumbering', arguments[0]);
        });
